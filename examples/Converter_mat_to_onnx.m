...
load('mnist5x50.mat');
filesave = 'mnist_model5x50'; % name to save the network as
file = mnist_5x50;
...
lin = imageInputLayer([1 784], 'Name', 'input','AverageImage',ones([1 784]));
lgraph = layerGraph;
...
% deepNetworkDesigner % Oen visualizer for Series Network
