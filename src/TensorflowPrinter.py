...
# Get the size of the network
    ...
    def save_nnmat_file(self,ni,no,nl,n,lsize,W,b,lys):
    ...
    def parse_nn(self,filename):
        [w,w1] = self.load_network(self,filename)
        [ni,no,nl] = self.get_shape(self,filename)
        lys = self.get_layers(self,w,w1)
        [W,b,lsize,n] = self.get_parameters(self,w)
        self.save_nnmat_file(self,ni,no,nl,n,lsize,W,b,lys)
